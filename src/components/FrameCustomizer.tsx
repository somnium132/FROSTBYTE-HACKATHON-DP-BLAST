...
import { Upload, RefreshCw, ZoomIn, ZoomOut, Move, RotateCw, Sparkles, Terminal, Calendar, MapPin } from "lucide-react";
...
export default function FrameCustomizer() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      setStatus("DP generated successfully! Customize your caption below.");
